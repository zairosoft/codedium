...
@section('content')
    ...
    <div x-data="sorting">
        <div class="mb-5 flex flex-wrap items-center justify-between gap-4">
            <div class="text-lg font-semibold ltr:sm:text-left rtl:sm:text-right dark:text-white-light">เว็บไซต์</div>
                ...
                <div class="px-5">
                    <div class="md:absolute btn-add">
                        <div class="flex items-center">
                            <a href="{{ route('website.create') }}" class="btn btn-primary">
            ...
            Alpine.data('sorting', () => ({
                ...
                initializeTable() {
                    this.datatable = new simpleDatatables.DataTable('#myTable', {
                        data: {
                            headings: ["ลำดับ", "ชื่อ", "สถานะ", "Slug", "Keyword", "วันที่", "ดู@can('user update') / แก้ไข@endcan @can('user delete') / ลบ@endcan"],
                            data: this.dataArr,
                        },
                        perPage: 20,
