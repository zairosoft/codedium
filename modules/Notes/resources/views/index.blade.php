                        ...
                        >
                            ...
                            <li class="nav-item">
                                <ul>
                                    ...
                                    <li class="nav-item">
                                        <a href="apps-notes.html" class="active group">
                                            <div class="flex items-center">
                                                <svg
                                                    class="shrink-0 group-hover:!text-primary"
                                                    width="20"
                    ...
                    <div x-data="notes">
                        <div class="relative flex h-full gap-5 sm:h-[calc(100vh_-_150px)]">
                            ...
                            <div class="panel h-full flex-1 overflow-auto">
                                                            ...
                                                            <div class="flex items-center">
                                                                ...
                                                                <button type="button" class="group text-warning ltr:ml-2 rtl:mr-2" @click="setFav(note)">
                                                                    <svg
                                                                        ...
                                                                        fill="none"
                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                        class="h-4.5 w-4.5 group-hover:fill-warning"
                                    ...
                                    <div class="flex min-h-screen items-center justify-center">
                                        ...
                                        >
                                            ...
                                            <div
                                                ...
                                                x-text="params.id ? 'Edit Note' : 'Add Note'"
                                            ></div>
                                            <div class="p-5">
                                                <form @submit.prevent="saveNote">
                                                    ...
                                                    <div class="mt-8 flex items-center justify-end">
                                                        ...
                                                        <button
                                                            ...
                                                            x-text="params.id ? 'Update Note' : 'Add Note'"
                                                        ></button>
                                                    </div>
                                                </form>
                                            </div>
                                ...
                                <div class="fixed inset-0 z-[999] hidden overflow-y-auto bg-[black]/60 px-4" :class="isDeleteNoteModal && '!block'">
                                    <div class="flex min-h-screen items-center justify-center">
                                        <div
                                            x-show="isDeleteNoteModal"
                                            x-transition
                                            x-transition.duration.300
                                ...
                                <div class="fixed inset-0 z-[999] hidden overflow-y-auto bg-[black]/60 px-4" :class="isViewNoteModal && '!block'">
                                    <div class="flex min-h-screen items-center justify-center">
                                        <div
                                            x-show="isViewNoteModal"
                                            x-transition
                                            x-transition.duration.300
