...
@section('content')
    <div>
        ...
        <div class="mb-5 flex flex-wrap items-center justify-between gap-4">
            <div class="text-lg font-semibold ltr:sm:text-left rtl:sm:text-right dark:text-white-light">แก้ไขอนุโมทนาบัตร
            </div>
                        ...
                        <div class="w-full lg:w-1/2 lg:max-w-fit">
                            ...
                            <div class="mt-4 flex items-center">
                                ...
                                <input id="date" type="date" name="date" class="form-input w-2/3 lg:w-[250px]" required
                                    value="{{ old('date', $intentform->date) }}" />
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tr class="border-b border-[#e0e6ed] align-top dark:border-[#1b2e4b]">
                                            <td>
                                                <select :name="'type_id['+i+']'" class="form-select min-w-[200px]"
                                                    @change="updatePrice($event, i)" x-model="item.type_id">
                    ...
                    <div class="mt-8 px-4">
                        <div>
                            ...
                            <textarea id="notes" name="notes" class="form-textarea min-h-[130px]"
                                placeholder="หมายเหตุ....">{{ old('notes', $intentform->notes) }}</textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel mb-5">
                        <div>
                            ...
                            <select id="status" name="status" class="form-select" required>
                                <option value="1" {{ old('status', $intentform->status) == '1' ? 'selected' : '' }}>ใช้งาน
                                </option>
                                <option value="0" {{ old('status', $intentform->status) == '0' ? 'selected' : '' }}>ไม่ใช้งาน
                                </option>
                            </select>
                        </div>
                        <div class="mt-4">
