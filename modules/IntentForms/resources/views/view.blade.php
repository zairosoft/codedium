                    ...
                    <div class="flex flex-wrap justify-between">
                        ...
                        <div class="w-full lg:w-1/2 lg:max-w-fit">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <div class="ml-4">{{ sprintf('%03d', $intentform->volume) }} /
                                    {{ sprintf('%02d', $intentform->number) }}</div>
                            </div>
                            <div class="flex items-center justify-between mb-2">
                    ...
                    <div class="flex flex-col justify-between lg:flex-row px-4">
                        ...
                        <div class="w-full lg:w-1/2">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex">
                                    <div class="font-semibold w-1/3">แก่มูลนิธิ:</div>
                                    <div class="flex-1">{{ number_format($intentform->total, 2) }} บาท</div>
                                </div>
                                <div class="flex">
                        ...
                        <table>
                            ...
                            <tfoot>
                                <tr class="bg-gray-100 dark:bg-gray-700">
                                    ...
                                    <td class="text-right font-semibold p-4">{{ number_format($intentform->total, 2) }} บาท
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
