...
@section('content')
    <div>
        <div class="mb-5 flex flex-wrap items-center justify-between gap-4">
            <div class="text-lg font-semibold ltr:sm:text-left rtl:sm:text-right dark:text-white-light">เพิ่มค่าใช้จ่าย
            </div>
                            ...
                            <div class="w-full lg:w-1/2">
                                ...
                                <div class="mt-4 flex items-center">
                                    ...
                                    <select id="payment_method" name="payment_method" class="form-select flex-1" required>
                                        <option value="เงินสด" {{ old('payment_method', 'เงินสด') == 'เงินสด' ? 'selected' : '' }}>เงินสด</option>
                                        <option value="เงินโอน" {{ old('payment_method') == 'เงินโอน' ? 'selected' : '' }}>
                                            เงินโอน</option>
                                        <option value="บัตรเครดิต" {{ old('payment_method') == 'บัตรเครดิต' ? 'selected' : '' }}>บัตรเครดิต</option>
                                    </select>
                                </div>
                                <div class="mt-4 flex items-center">
                                ...
                                <div class="mt-4 flex items-center">
                                    ...
                                    <input id="account_number" type="text" name="account_number" class="form-input flex-1"
                                        placeholder="กรอกหมายเลขบัญชี" value="{{ old('account_number') }}" />
                                </div>
                                <div class="mt-4 flex items-center">
                                    ...
                                    <input id="description" type="text" name="description" class="form-input flex-1"
                                        placeholder="กรอกรายละเอียด" value="{{ old('description') }}" />
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tr class="border-b border-[#e0e6ed] align-top dark:border-[#1b2e4b]">
                                            <td>
                                                <select :name="'category_id['+i+']'"
                                                    class="form-select min-w-[200px] category-select">
