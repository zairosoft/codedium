                ...
                <div class="px-5">
                    <div class="md:absolute btn-add">
                        <div class="flex items-center gap-2">
                            ...
                            <a href="{{ url('expenses/categories') }}" class="btn btn-outline-primary">
                                จัดการหมวดหมู่
                            </a>
                        </div>
                    </div>
            ...
            Alpine.data('sorting', () => ({
                ...
                initializeTable() {
                    this.datatable = new simpleDatatables.DataTable('#myTable', {
                        data: {
                            headings: ["ลำดับ", "วันที่", "เลขที่อ้างอิง", "หมวดหมู่", "ผู้รับเงิน", "จำนวนเงิน", "สถานะ", "{{ __('others.view') }}@can('expenses update') / {{ __('others.edit') }}@endcan @can('expenses delete') / {{ __('others.delete') }}@endcan"],
                            data: this.dataArr,
                        },
                        perPage: 20,
