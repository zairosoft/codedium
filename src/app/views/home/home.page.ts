    ...
    <main class="mx-auto max-w-5xl px-4 py-14">
      <section class="rounded-3xl border border-slate-200/60 bg-white/80 p-8 shadow-xl backdrop-blur-sm">
        ...
        <div class="mt-6 flex flex-wrap gap-3">
          <a class="inline-flex items-center justify-center rounded-xl bg-gradient-to-br from-teal-600 to-teal-800 px-5 py-3 text-sm font-bold text-white shadow-md transition hover:-translate-y-0.5"
             href="/api/v1/modules">
            Open system modules
          </a>
          <a class="inline-flex items-center justify-center rounded-xl border border-slate-200 bg-white/70 px-5 py-3 text-sm font-bold text-slate-700 transition hover:-translate-y-0.5"
