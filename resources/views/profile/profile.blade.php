    ...
    <div class="mb-5 flex flex-wrap items-center justify-between gap-4">
        ...
        <div class="flex flex-wrap items-center justify-between gap-4">
            <ul class="flex text-gray-500 dark:text-white-dark">
                ...
                <li class="before:content-['/'] before:px-1.5"><a href="javascript:;" class="text-black dark:text-white-light hover:text-black/70 dark:hover:text-white-light/70">โปรไฟล์</a></li>
            </ul>
        </div>
    </div>
    <div>
        <div class="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-5 mb-5">
            <div class="panel">
                <div class="flex items-center justify-between mb-5">
                    <a href="{{ route('profileedit') }}" class="ltr:ml-auto rtl:mr-auto btn btn-primary p-2 rounded-full">
                ...
                <div class="mb-5">
                    <div class="flex flex-col justify-center items-center">
                        <img src="{{ asset(auth()->user()->img === null ? "assets/images/user.png" : "assets/images/users/".auth()->user()->img) }}" alt="image" class="w-24 h-24 rounded-full object-cover  mb-5" />
                ...
                <div class="space-y-4">
                    <div class="border border-[#ebedf2] rounded dark:bg-[#1b2e4b] dark:border-0">
                        <div class="flex items-center justify-between p-4 py-2">
                            <div class="shrink-0 grid place-content-center w-9 h-9 rounded-md bg-secondary-light dark:bg-secondary text-secondary dark:text-secondary-light">
                    ...
                    <div class="border border-[#ebedf2] rounded dark:bg-[#1b2e4b] dark:border-0">
                        <div class="flex items-center justify-between p-4 py-2">
                            <div class="shrink-0 grid place-content-center w-9 h-9 rounded-md bg-info-light dark:bg-info text-info dark:text-info-light">
                    ...
                    <div class="border border-[#ebedf2] rounded dark:bg-[#1b2e4b] dark:border-0">
                        <div class="flex items-center justify-between p-4 py-2">
                            <div class="shrink-0 grid place-content-center w-9 h-9 rounded-md bg-warning-light dark:bg-warning text-warning dark:text-warning-light">
                ...
                <div>
                    <div class="border-b border-[#ebedf2] dark:border-[#1b2e4b]">
                        <div class="flex items-center justify-between py-2">
                            <h6 class="text-[#515365] font-semibold dark:text-white-dark">กิจกรรมเข้าสู่ระบบล่าสุด
                                <span class="block text-white-dark dark:text-white-light">{{ auth()->user()->last_logged_activities }}</span>
                            </h6>
                        </div>
                    </div>
                    <div class="border-b border-[#ebedf2] dark:border-[#1b2e4b]">
                        <div class="flex items-center justify-between py-2">
                            <h6 class="text-[#515365] font-semibold dark:text-white-dark">เข้าสู่ระบบครั้งล่าสุดเมื่อ
                                <span class="block text-white-dark dark:text-white-light">{{ auth()->user()->last_logged_at }}</span>
                            </h6>
                        </div>
                    </div>
                    <div>
                        <div class="flex items-center justify-between py-2">
                            <h6 class="text-[#515365] font-semibold dark:text-white-dark">อัพเดทล่าสุดเมื่อ
                                <span class="block text-white-dark dark:text-white-light">{{ auth()->user()->updated_at }}</span>
                            </h6>
...
@if (\Session::has('success'))  setTimeout(() => {window.onload = showAlert();}, "500"); @endif
</script>
@endsection
