...
@section('content')
    <div>
        <div class="mb-5 flex flex-wrap items-center justify-between gap-4">
            <div class="text-lg font-semibold ltr:sm:text-left rtl:sm:text-right dark:text-white-light">เพิ่มบทบาท</div>
            ...
            <div class="mb-5">
                <form action="{{ url('roles') }}" method="POST">
                    ...
                    <div class="@error('name')has-error @enderror">
                        ...
                        <input id="fullName" type="text" name="name" value="{{ old('name') }}" placeholder="ป้อนบทบาท" class="form-input" />
                        @if ($errors->has('name'))
