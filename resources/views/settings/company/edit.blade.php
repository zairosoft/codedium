        ...
        <div class="mb-5 flex flex-wrap items-center justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center justify-between gap-4">
                <ul class="flex text-gray-500 dark:text-white-dark">
                    ...
                    <li class="before:content-['/'] before:px-1.5"><a href="javascript:;" class="text-black dark:text-white-light hover:text-black/70 dark:hover:text-white-light/70">{{ __('companies.edit_company') }}</a>
                    </li>
                </ul>
            </div>
        </div>
                                ...
                                <div class="space-y-5 flex-1 grid">
                                    <div>
                                        ...
                                        <div class="relative text-white-dark @error('name')has-error @enderror">
                                            <input id="name" type="text" placeholder="{{ __('companies.input.enter_company_name') }}" name="name" value="{{ old('name', $lang->name) }}" class="form-input" />
                                        </div>
                                        @error('name')
                                            <div>
                                    ...
                                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        <div>
                                            ...
                                            <input id="tel" type="text" name="tel" value="{{ old('tel', $company->tel) }}" placeholder="{{ __('companies.input.enter_phone_number') }}" class="form-input">
                                        </div>
                                        <div>
                                            <label for="phone">{{ __('companies.mobile') }}</label>
                                            <input id="phone" type="text" name="mobile" value="{{ old('mobile', $company->mobile) }}" placeholder="{{ __('companies.input.enter_mobile_phone') }}" class="form-input">
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        <div>
                                            ...
                                            <div class="relative text-white-dark @error('email')has-error @enderror">
                                                <input id="email" type="text" placeholder="{{ __('companies.input.enter_email') }}" value="{{ old('email', $company->email) }}" name="email" class="form-input" />
                                            </div>
                                            @error('email')
                                                <div>
                                        ...
                                        <div>
                                            ...
                                            <input id="website" type="url" name="website" value="{{ old('website', $company->website) }}" placeholder="{{ __('companies.input.enter_website') }}" class="form-input">
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-4">
                                        <div class="md:col-span-2">
                                            <label for="tel">{{ __('companies.tax_id_number') }}</label>
                                            <input id="tel" type="text" name="tax_id" value="{{ old('tax_id', $company->tax_id) }}" placeholder="{{ __('companies.input.enter_tax_number') }}" class="form-input">
                                        </div>
                                        <div>
                                            <label for="phone">{{ __('companies.company_id') }}</label>
                                            <input id="phone" type="text" name="company_id" value="{{ old('company_id', $company->company_id) }}" placeholder="{{ __('companies.input.enter_company_id') }}" class="form-input">
                                        </div>
                                        <div>
                                    ...
                                    <div>
                                        ...
                                        <textarea id="gridAddress" class="form-textarea" name="address" placeholder="{{ __('companies.input.enter_address') }}" style="height: 75px;">{{ old('address', $lang->address) }}</textarea>
                                    </div>
                                    <div class="grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-4">
                                        <div>
                                            <label for="city">{{ __('companies.address.city') }}</label>
                                            <input id="city" type="text" name="city" value="{{ old('city', $lang->city) }}" placeholder="{{ __('companies.input.enter_city') }}" class="form-input">
                                        </div>
                                        <div>
                                            <label for="province">{{ __('companies.address.province') }}</label>
                                            <input id="province" type="text" name="province" value="{{ old('province', $lang->province) }}" placeholder="{{ __('companies.input.enter_province') }}" class="form-input">
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <input id="postalCode" type="text" name="postal_code" value="{{ old('postal_code', $lang->postal_code) }}" placeholder="{{ __('companies.input.enter_postal') }}" class="form-input">
                                        </div>
                                    </div>
