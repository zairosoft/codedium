...
@section('content')
    ...
    <div x-data="sorting">
        <div class="mb-5 flex flex-wrap items-center justify-between gap-4">
            <div class="text-lg font-semibold ltr:sm:text-left rtl:sm:text-right dark:text-white-light">รายการบริษัท</div>
            <div class="flex flex-wrap items-center justify-between gap-4">
                <ul class="flex text-gray-500 dark:text-white-dark">
                    ...
                    <li class="before:content-['/'] before:px-1.5"><a href="javascript:;" class="text-black dark:text-white-light hover:text-black/70 dark:hover:text-white-light/70">บริษัท</a></li>
                </ul>
            </div>
        </div>
                ...
                <div class="px-5">
                    <div class="md:absolute btn-add">
                        <div class="flex items-center">
                            <a href="{{ url('settings/company/create') }}" class="btn btn-primary">
            ...
            Alpine.data('sorting', () => ({
                ...
                initializeTable() {
                    this.datatable = new simpleDatatables.DataTable('#myTable', {
                        data: {
                            headings: ["ลำดับ", "รูป", "ชื่อ", "อีเมล", "เบอร์โทรศัพท์",
                                "Tax id",
                                "ดู@can('setting update') / แก้ไข@endcan @can('setting delete') / ลบ@endcan"
                            ],
                            data: this.dataArr,
                        },
                        perPage: 20,
                ...
                deleteItem() {
                    ...
                    fetch("{{ url('settings/company') }}/delete", {
                        method: "DELETE",
                        headers: {
